        ...
        <List
          ...
          renderItem={(item, index) => (
            <RoomListItem
              ...
              handleOpenTruthOrDare={() => addTruthOrDare(index)}
            />
          )}
        />
      </Scroll>
  ...
  return (
    <List.Item style={{ padding: "8px" }}>
      <div>
        ...
        <Link style={{ marginLeft: "12px" }} onClick={handleOpenTruthOrDare}>
          打开真心话大冒险
        </Link>
